...
-   python-es-lecciones8.zip ([zip sync][])
  ...
  [Salida de datos como archivo HTML]: {{ site.baseurl }}/lecciones/salida-de-datos-como-archivo-html
  [Contar frecuencias de palabras]: {{ site.baseurl }}/lecciones/contar-frecuencias
