...
saver.
  ...
  [Working with Web Pages]: {{ site.baseurl }}/lessons/working-with-web-pages
  [From HTML to List of Words (part 1)]: {{ site.baseurl }}/lessons/from-html-to-list-of-words-1
  [Intro to Beautiful Soup]: {{ site.baseurl }}/lessons/intro-to-beautiful-soup
  ...
  [Installing Python Modules with pip]: {{ site.baseurl }}/lessons/installing-python-modules-pip
