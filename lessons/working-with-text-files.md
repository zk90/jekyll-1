...
-   [Non-Programmer’s Tutorial for Python 2.6/Hello, World][]
  ...
  [Mac Installation]: {{ site.baseurl }}/lessons/mac-installation
  [Windows Installation]: {{ site.baseurl }}/lessons/windows-installation
  [Linux Installation]: {{ site.baseurl }}/lessons/linux-installation
