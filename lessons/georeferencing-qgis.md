...
*This lesson is part of the [Geospatial Historian][].*
  ...
  [Intro to Google Maps and Google Earth]: {{ site.baseurl }}/lessons/googlemaps-googleearth
  ...
  [Installing QGIS 2.0 and adding Layers]: {{ site.baseurl }}/lessons/qgis-layers
  ...
  [Creating New Vector Layers in QGIS]: {{ site.baseurl }}/lessons/vector-layers-qgis
