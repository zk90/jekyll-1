...
-   python-lessons8.py ([zip sync][])
  ...
  [Output Data as HTML File]: {{ site.baseurl }}/lessons/output-data-as-html-file
  [Counting Frequencies]: {{ site.baseurl }}/lessons/counting-frequencies
  [1]: output-data-as-html-file
  [zip file from the previous lesson]: {{ site.baseurl }}/assets/python-lessons7.zip
  [Manipulating Strings in Python]: {{ site.baseurl }}/lessons/manipulating-strings-in-python
  [zip sync]: {{ site.baseurl }}/assets/python-lessons8.zip
