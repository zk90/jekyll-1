...
There is an additional lesson on using Python to download multiple records using Query Strings, marked as the next lesson.
  ...
  [Keywords in Context (Using N-grams)]: {{ site.baseurl }}/lessons/keywords-in-context-using-n-grams
  [zip file from the previous lesson]: {{ site.baseurl }}/assets/python-lessons8.zip
  [Output Data as HTML File]: /lessons/output-data-as-html-file
  [zip sync]: {{ site.baseurl }}/assets/python-lessons9.zip
